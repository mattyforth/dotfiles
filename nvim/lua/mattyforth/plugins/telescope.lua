return { -- Fuzzy Finder (files, lsp, etc)
  ...
  dependencies = {
    ...
    -- Allows regular neovim selects to use telescope select box.
  ...
  config = function()
    ...
    vim.keymap.set('n', '<leader>ss', builtin.lsp_dynamic_workspace_symbols, {desc = 'Search document symbols'})
